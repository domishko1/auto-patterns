...
public class ElectronicsCompanySearchStrategy implements SearchStrategy{
    ...
    private final SelenideElement title = $x("//a[@href=\"https://doramy.club/33579-kompaniya-gaus-elektroniks.html\"]");
    private final SelenideElement searchName = $x("//a[@href=\"https://doramy.club/akter/kan-min-a\"]");

    @Override
    public void search() {
        searchField.click();
        searchField.sendKeys("Компания Гаус Электроникс");
        searchBtn.click();
        title.click();
        searchName.click();
    }
